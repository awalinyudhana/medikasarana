...
class Users extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $crud->set_table('staff')
            ...
            ->display_as('id_group', 'Nama Bagian')
            ->display_as('name', 'Nama Pegawai')
            ->display_as('username', 'Nama Pengguna')
            ->display_as('nip', 'NIP')
            ->display_as('register_date', 'Tanggal Daftar')
    ...
    public function group()
    {
        ...
        $crud->set_table('staff_group')
            ...
            ->display_as('name_group', 'Nama Bagian')
            ->display_as('roles', 'Jumlah Pengguna')

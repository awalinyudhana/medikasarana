...
class Product extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $crud->set_table('product')
            ...
            ->display_as('brand', 'Merek')
            ->display_as('id_product_unit', 'Satuan Produk')
            ->display_as('sell_price', 'Harga Retail')
            ->display_as('date_expired', 'Tanggal Kadaluarsa')
            ->display_as('stock', 'stok')
            ->display_as('license', 'AKL/AKD')
            ->display_as('minimum_stock', 'Stok Minimal')
...
//            ->unique_fields('barcode')
    ...
    public function category($action = null, $id_product_category = null)
    {
        ...
        $crud->set_table('product_category')
            ...
            ->display_as('parent', 'Parent Kategori')

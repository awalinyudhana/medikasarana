...
class History extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $crud->set_table('purchase_order')
            ->columns('id_purchase_order','invoice_number', 'id_principal', 'id_staff', 'status_ppn', 'date', 'due_date', 'total','dpp', 'ppn', 'discount_price', 'grand_total')
            ->display_as('id_purchase_order', 'No Faktur PO')
            ->display_as('invoice_number', 'No Faktur Beli')
            ->display_as('status_ppn', 'Status PPN')
            ->display_as('id_principal', 'Prinsipal')
            ->display_as('id_staff', 'Staff')
            ->display_as('date', 'Tanggal Transaksi')
            ->display_as('due_date', 'Jatuh Tempo')
            ->display_as('dpp', 'DPP')
            ->display_as('ppn', 'PPN')
            ->display_as('discount_price', 'Diskon')

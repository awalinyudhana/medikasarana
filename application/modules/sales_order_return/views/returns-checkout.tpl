        ...
        <table border="0" width="100%">
            <tr>
                ...
                <td align="right" valign="center">
                    No Faktur Retur# <strong class="text-danger pull-right">{$master->id_sales_order_return}</strong></br>
                    No Faktur Retail# <strong class="text-danger pull-right">{$master->id_sales_order}</strong></br>
            ...
            <div class="row invoice-header">
                ...
                <div class="col-sm-3 pull-right">
                    <ul>
                        ...
                        <li>No Faktur Retail# <strong class="text-danger pull-right">{$master->id_sales_order}</strong></li>

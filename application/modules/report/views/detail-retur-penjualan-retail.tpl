...
{block name=content}
        <div class="panel panel-default">
            ...
            <div class="panel-heading"><h6 class="panel-title">Detail Laporan Retur Penjualan Retail</h6></div>

            <div class="panel-body">
                <div class="block-inner">
                    <h6 class="heading-hr">
                        <i class="icon-coin"></i> Detail Laporan Retur Penjualan Retail <small class="display-block">No Retur #{$id_retail_return}</small>
                    </h6>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4 pull-right">
                        <div class="btn-group right-box">
                            <a href="{base_url('report/retur-penjualan-retail')}"  class="btn block full-width btn-default">Kembali
                            </a>
                        </div>
                    </div>
                </div>

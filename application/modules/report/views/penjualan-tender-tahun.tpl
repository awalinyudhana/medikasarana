        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="block-inner">
                    <h6 class="heading-hr">
                        <i class="icon-coin"></i>Ringkasan informasi penjualan per tahun <small class="display-block">Tender</small>
                    </h6>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h6 class="panel-title">Detail Rincian Penjualan Tender Per Konsumen<br> Tahun {$from} - {$to}</h6>
                            </div>
                            <div class="panel-body">

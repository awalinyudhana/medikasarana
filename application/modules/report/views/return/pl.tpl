        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="block-inner">
                    <h6 class="heading-hr">
                        <i class="icon-coin"></i>Laporan Retur Penjualan Pengadaan Langsung <small class="display-block">Periode {$from} - {$to}</small>
                    </h6>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-8" style="text-align: right;margin-bottom: 10px;">
                        <a class="btn btn-warning" download="laporan-retur-penjualan-pengadaan-periode-{$from}-{$to}.xls" href="#" onclick="return ExcellentExport.excel(this, 'datatableexport', 'Laporan Retur Penjualan Pengadaan Langsung  Periode {$from} - {$to}');">Export to Excel</a>
                    </div>
                </div>
                       ...
                       <!--  <thead>
                        ...
                        {foreach $items as $key }
                            <tr>
                                ...
                                No Faktur Jual : {$key['id_retail']}</br>

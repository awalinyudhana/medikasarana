...
{block name=content}
        <div class="panel panel-default">
            ...
            <div class="panel-heading"><h6 class="panel-title">Laporan Retur Penjualan</h6></div>

            <div class="panel-body">
                <div class="block-inner">
                    <h6 class="heading-hr">
                        <i class="icon-coin"></i>Laporan Retur Penjualan<small class="display-block">Periode {$from} - {$to}</small>
                    </h6>
                </div>

                <form action="{current_url()}" method="post" role="form">
                    <div class="form-group">
                        <label>Tanggal Transaksi Retur Penjualan:</label>
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{base_url('report/retur-penjualan')}\" class="btn btn-warning">Reset</a>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <div class="row">
                    <div class="col-md-4 col-md-offset-8" style="text-align: right;margin-bottom: 10px;">
                        <a class="btn btn-warning" download="laporan-retur-penjualan-periode-{$from}-{$to}.xls" href="#" onclick="return ExcellentExport.excel(this, 'datatableexport', 'Laporan Retur Penjualan  Periode {$from} - {$to}');">Export to Excel</a>
                    </div>
                </div>

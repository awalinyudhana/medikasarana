        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="block-inner">
                    <h6 class="heading-hr">
                        <i class="icon-coin"></i> Ringkasan informasi penjualan per tahun <small class="display-block">Pengadaan Langsung</small>
                    </h6>
                </div>

                <form action="{current_url()}" method="post" role="form">
                    <div class="form-group">
                        <label>Tanggal Transaksi Pengadaan Langsung :</label>
                        <div class="row">
                            <div class="col-md-4">
                                <input type="text" class="from-year-report form-control" name="date_from" placeholder="From" {if isset($form_from)} value="{$form_from}"{/if}>
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="to-year-report form-control" name="date_to" placeholder="To" {if isset($form_to)} value="{$form_to}"{/if}>
                            </div>
                            <div class="col-md-4">
                                <input type="submit" value="Pilih" class="btn btn-success">
                                <a href="{base_url('report/penjualan/pengadaan/year')}" class="btn btn-warning">Reset</a>
                            </div>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h6 class="panel-title">Detail Rincian Penjualan Pengadaan Langsung Per Konsumen<br> Tahun {$from} - {$to}</h6>
                            </div>
                            <div class="panel-body">

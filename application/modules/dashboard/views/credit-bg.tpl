...
{block name=content}
        <div class="panel panel-default">
            ...
            <div class="panel-heading"><h6 class="panel-title">Informasi Daftar Hutang Cek BG < 14 Hari</h6></div>

            <div class="panel-body">
                <div class="block-inner">
                    <h6 class="heading-hr">
                        <i class="icon-coin"></i> Informasi Daftar Hutang Cek BG<small class="display-block">Daftar Cek BG belum cair</small>
                    </h6>
                </div>
            </div><!-- /panel body -->
